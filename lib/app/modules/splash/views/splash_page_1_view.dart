...
class SplashPage1View extends GetView {
  const SplashPage1View({super.key});
  @override
    ...
    Widget bagianContent() {
      return Container(
        ...
        child: Column(
          children: [
            Text(
              "Berasa membantu semua\norang",
              textAlign: TextAlign.center,
              style: abu2Sty.copyWith(fontSize: 22, fontWeight: bold),
            ),
            SizedBox(height: 10),
            Text(
              "Berasa Aplikasi untuk membantu\nsemua orang agar tidak kelaparan",
              textAlign: TextAlign.center,
